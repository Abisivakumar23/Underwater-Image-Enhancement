...
close all
clear all
im = im2double(imread('C:\Users\itops_\Desktop\Publication Work\UG Project (Underwater Enhancement)\Underwater-Image-Enhancement-by-Wavelength-Compensation-and-Dehazing-master\Underwater-Image-Enhancement-by-Wavelength-Compensation-and-Dehazing-master\Data\hazed2.jpg'));
imshow(im);
